...
unsafe extern "C" {
    ...
    pub fn CLD2_ResultChunkVector_data(chunks: *const ResultChunks) -> *const ResultChunk;
    pub fn CLD2_ResultChunkVector_size(chunks: *const ResultChunks) -> usize;
    ...
    pub fn CLD2_DetectLanguage(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
        is_reliable: *mut bool,
    ) -> Language;
    pub fn CLD2_DetectLanguageSummary(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
    ...
    pub fn CLD2_DetectLanguageSummary2(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
    ...
    pub fn CLD2_ExtDetectLanguageSummary(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
        language3: *mut Language,
    ...
    pub fn CLD2_ExtDetectLanguageSummary2(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
        tld_hint: *const c_char,
    ...
    pub fn CLD2_ExtDetectLanguageSummary3(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
        tld_hint: *const c_char,
    ...
    pub fn CLD2_ExtDetectLanguageSummary4(
        buffer: *const c_char,
        buffer_length: c_int,
        is_plain_text: bool,
